namespace Castle.Facilities.NHibernateIntegration.Internal
{
	...
	public class AdoBoundTransaction : ITransaction
	{
		private static readonly IInternalLogger log = LoggerProvider.LoggerFor(typeof(AdoBoundTransaction));
		...
		public AdoBoundTransaction(ISessionImplementor session)
		{
